...
public class TestListener implements ITestListener, IAnnotationTransformer {
	...
	public void onTestSuccess(ITestResult result) {
		...
		if(!result.getTestClass().getName().toLowerCase().contains("api")) {
			ExtentManager.logStepWithScreenshot(BaseClass.getDriver(), "Test Passed Successfully!",
					"Test End: " + testName + " - ✔︎ Test Passed");
		}
		else {
			ExtentManager.logStepValidationForAPI("Test End: " + testName + " - ✔︎ Test Passed");
		}
	...
	public void onTestFailure(ITestResult result) {
		...
		if(!result.getTestClass().getName().toLowerCase().contains("api")) {
			ExtentManager.logFailure(BaseClass.getDriver(), "Test Failed!", "Test End: " + testName + " - ✖︎ Test Failed");
		}
		else {
			ExtentManager.logFailureAPI("Test End: " + testName + " - ✖︎ Test Failed");
		}
	}
